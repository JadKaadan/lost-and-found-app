...
public class PetDetailsActivity extends AppCompatActivity {
        ...
        petsRef.child(petId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (pet != null) {
                    ...
                    // Show "Mark as Found" button only for the owner and if it's in the LostPets
                    // section !!
                    if (isLostSection) {
    ...
    private void populatePetDetails(Pet pet) {
        ...
        tvReward.setText(
                pet.getReward() != null && !pet.getReward().isEmpty() ? "Reward: " + pet.getReward() : "No Reward");
    ...
    private void setContactActions(String phone, String email) {
        if (phone != null && !phone.isEmpty()) {
            btnCallOwner
                    .setOnClickListener(v -> startActivity(new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + phone))));
