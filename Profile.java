...
public class Profile extends AppCompatActivity {
    ...
    private void loadUserProfile() {
        ...
        database.child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(Profile.this, "Failed to load profile: " + error.getMessage(), Toast.LENGTH_SHORT)
                        .show();
            }
        });
    }
                    ...
                    database.child(userId).child("profilePictureUrl").setValue(imageUrl)
                            .addOnCompleteListener(task -> {
                                if (task.isSuccessful()) {
                                    Toast.makeText(Profile.this, "Profile picture updated successfully!",
                                            Toast.LENGTH_SHORT).show();
                                } else {
                                    Toast.makeText(Profile.this, "Failed to update profile picture", Toast.LENGTH_SHORT)
                                            .show();
                                }
                            });
                }))
                .addOnFailureListener(e -> Toast
                        .makeText(Profile.this, "Image upload failed: " + e.getMessage(), Toast.LENGTH_SHORT).show());
    }
    ...
    private void removeProfilePicture() {
        ...
        storageReference.child(userId + ".jpg").delete().addOnCompleteListener(task -> {
            if (!task.isSuccessful()) {
                Toast.makeText(Profile.this, "Failed to delete profile picture from storage.", Toast.LENGTH_SHORT)
                        .show();
            }
        });
    }
