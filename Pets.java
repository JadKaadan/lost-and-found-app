...
public class Pets extends AppCompatActivity {
    ...
    private boolean isLostSection = true;
    ...
    private void loadFoundPets() {
        foundPetsRef.addValueEventListener(new com.google.firebase.database.ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Pets.this, "Failed to load found pets: " + error.getMessage(), Toast.LENGTH_SHORT)
                        .show();
            }
        });
    }
    ...
    private void uploadPetImage(Dialog dialog, String petName, String petType, String lastSeen, String reward) {
        ...
        imageRef.putFile(petImageUri)
                .addOnSuccessListener(taskSnapshot -> imageRef.getDownloadUrl().addOnSuccessListener(uri -> {
                    String imageUrl = uri.toString();
                    savePetDetailsToDatabase(petName, petType, lastSeen, reward, imageUrl, dialog);
                }).addOnFailureListener(e -> Toast
                        .makeText(Pets.this, "Failed to get image URL: " + e.getMessage(), Toast.LENGTH_SHORT).show()));
    }

    private void savePetDetailsToDatabase(String petName, String petType, String lastSeen, String reward,
            String imageUrl, Dialog dialog) {
